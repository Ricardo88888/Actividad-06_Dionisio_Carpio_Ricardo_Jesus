...
public class DocenteController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listaDocentePorDniNombreConParametros(
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listaDocentePorDniNombreUbigeoConParametros(
			@RequestParam(value = "nombre",required = false, defaultValue = "")String nombre,
			@RequestParam(value = "dni",required = false, defaultValue = "")String dni,
			...
			@RequestBody FiltroDocente filtro)
	{
		...
		try {
			...
			List<Docente> lista = docenteService . listaDocentePorFiltro(filtro);
			if (CollectionUtils.isEmpty(lista)) {
				salida.put("mensaje", "No existe elementos para la consulta.");
			}else {
				salida.put("lista", lista);
